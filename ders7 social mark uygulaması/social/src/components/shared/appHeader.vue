  ...
  <!-- bu kısım navbar -->
     <div class="header-container">
      <nav class="flex w-full px-2">
        ...
        <!-- eğer kullanıcı login olmuşsa navbarı görecek-->
        <div v-if=" _isAuthenticated" class="ml-auto flex items-center">
          ...
          <div class="relative group">
            ...
            <nav class="bg-white !z-10 rounded-md shadow-md p-2 w-56 flex flex-col absolute group-focus-within:visible top-full right-0 invisible">
              <router-link class="mb-2 menü-item" :to="{name:'Settings'}">
              ...
              <router-link class="mb-2 menü-item" :to="{name:'Favorites'}">  
              ...
              <router-link class="mb-2 menü-item" :to="{name:'Likes'}">  
...
export default {
  //login işlemini otomatikleştirme
  computed :{
